...
cors = CORS(app, resources={r"/api/process": {"origins": "*"}, r"/api/get_exploring_node_level_and_height":{"origins": "*"}, r"/api/get_image":{"origins": "*"},})
...
def get_image():
    ...
    if image_type == "feature_map":
        image_path = create_feature_map_image(rawdata, data_id, shape, var_node_id)
        return image_path
    elif image_type == "activation_matrix":
        image_path = create_activation_matrix_image(rawdata, data_id, shape, var_node_id)
        return image_path
